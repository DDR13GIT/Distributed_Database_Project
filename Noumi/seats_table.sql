...
BEGIN
    IF (MOD(p_seat_number, 2) = 1) THEN
        ...
        INSERT INTO Seats_Noumi_1 (seat_id, seat_availability, event_id)
        VALUES (p_seat_id, p_seat_availability, p_event_id);
        INSERT INTO Seats_Noumi_2 (seat_id, seat_section, seat_row, seat_number)
        VALUES (p_seat_id, p_seat_section, p_seat_row, p_seat_number);
        -- Insert into Seats_Deb table
    ELSE
        INSERT INTO Seats_Deb_1@site_link (seat_id, seat_availability, event_id)
        VALUES (p_seat_id, p_seat_availability, p_event_id);
        INSERT INTO Seats_Deb_2@site_link (seat_id, seat_section, seat_row, seat_number)
        VALUES (p_seat_id, p_seat_section, p_seat_row, p_seat_number);
    END IF;
